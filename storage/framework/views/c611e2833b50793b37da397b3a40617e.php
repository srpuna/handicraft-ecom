...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->id); ?>" <?php echo e(old('category_id', $product->category_id) == $category->id ? 'selected' : ''); ?>
                                ...
                                data-subcategories="<?php echo e(json_encode($category->subCategories)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                function updateSubCategories() {
                    ...
                    const currentSubCategoryId = <?php echo e($product->sub_category_id ?? 'null'); ?>;
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="discount_price" value="<?php echo e($product->discount_price); ?>"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 border p-2">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700">Material (Optional)</label>
                    <input type="text" name="material" value="<?php echo e(old('material', $product->material)); ?>" placeholder="e.g., Wood, Cotton, Metal"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 border p-2">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.001" name="weight" value="<?php echo e(old('weight', $product->weight)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-3 gap-2">
                    <div>
                        ...
                        <input type="number" step="0.01" name="length" value="<?php echo e(old('length', $product->length)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="width" value="<?php echo e(old('width', $product->width)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="height" value="<?php echo e(old('height', $product->height)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-2">
                    ...
                    <?php if($product->main_image): ?>
                        <p class="text-xs text-gray-500 mt-1">Current: <a href="<?php echo e($product->main_image); ?>" target="_blank"
                    ...
                    <?php if($product->images && count($product->images) > 0): ?>
                        <div class="mt-2 flex gap-2 flex-wrap">
                            <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img src="<?php echo e($image); ?>" alt="" class="h-16 w-16 object-cover rounded border">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" rows="2"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 border p-2"
                        placeholder="Brief product summary"><?php echo e(old('description', $product->description)); ?></textarea>
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="long_description" rows="6"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 border p-2"
                        placeholder="Detailed product description with formatting"><?php echo e(old('long_description', $product->long_description)); ?></textarea>
                ...
                <div class="col-span-2 mt-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_order_now_enabled" id="is_order_now_enabled" <?php echo e($product->is_order_now_enabled ? 'checked' : ''); ?>
                ...
                <div class="col-span-2 grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_new_arrival" id="is_new_arrival" value="1"
                            class="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                            <?php echo e($product->is_new_arrival ? 'checked' : ''); ?>>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="is_on_sale" id="is_on_sale" value="1"
                            ...
                            <?php echo e($product->is_on_sale ? 'checked' : ''); ?>>
                ...
                <div class="col-span-2 md:col-span-1 mt-4">
                    ...
                    <input type="number" name="carousel_priority" value="<?php echo e(old('carousel_priority', $product->carousel_priority ?? 0)); ?>" min="0"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 border p-2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\My Files\Dev\ecom\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>