        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
            ...
            <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-4 border border-gray-200 hover:shadow-md transition-shadow">
                ...
                <div class="flex gap-2">
                    <a href="<?php echo e(route('admin.shipping.providers.show', $provider)); ?>" 
                    ...
                    <form action="<?php echo e(route('admin.shipping.providers.destroy', $provider)); ?>" method="POST" class="inline-block"
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\handmade handicraft\Desktop\Dev\ecom\resources\views/admin/shipping/providers.blade.php ENDPATH**/ ?>