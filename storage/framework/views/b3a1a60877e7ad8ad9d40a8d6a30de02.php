        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="border border-gray-200 rounded-lg p-4 bg-gradient-to-br from-blue-50 to-blue-100">
                ...
                <div class="space-y-3">
                    ...
                    <!-- Import Products -->
                    <form action="<?php echo e(route('admin.products.import')); ?>" method="POST" enctype="multipart/form-data" class="space-y-2">
                        <?php echo csrf_field(); ?>
                        <label class="block">
            ...
            <div class="border border-gray-200 rounded-lg p-4 bg-gradient-to-br from-purple-50 to-purple-100">
                ...
                <form action="<?php echo e(route('admin.products.bulk-images')); ?>" method="POST" enctype="multipart/form-data" class="space-y-3">
                    <?php echo csrf_field(); ?>
                    <label class="block">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\handmade handicraft\Desktop\Dev\ecom\resources\views/admin/products/index.blade.php ENDPATH**/ ?>