    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h2 class="text-xl font-bold flex items-center gap-2">
                Edit Order <span class="font-mono text-green-700"><?php echo e($order->order_number); ?></span>
            </h2>
...
<?php $__env->startSection('content'); ?>
    <div x-data="orderEditForm()" class="pb-10">
        <form action="<?php echo e(route('admin.orders.update', $order)); ?>" method="POST" id="orderEditForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="type"
                                    ...
                                    <?php echo e($order->isFinanciallyLocked() ? 'disabled' : ''); ?>>
                                    <option value="inquiry" <?php echo e(old('type', $order->type) == 'inquiry' ? 'selected' : ''); ?>>
                                        Inquiry (Draft Request)</option>
                                    <option value="order" <?php echo e(old('type', $order->type) == 'order' ? 'selected' : ''); ?>>Order
                                        (Confirmed)</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="client_id" x-model="client_id"
                                    ...
                                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($client->id); ?>" <?php echo e(old('client_id', $order->client_id) == $client->id ? 'selected' : ''); ?>>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="notes" rows="3"
                                    class="w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500"><?php echo e(old('notes', $order->notes)); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center justify-between mb-4 border-b pb-2">
                            ...
                            <?php if(!$order->isFinanciallyLocked()): ?>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                                        ...
                                        <div class="md:col-span-3" x-show="!item.product_id">
                                            ...
                                            <input type="text" :name="`items[${index}][product_name]`"
                                                ...
                                                placeholder="Custom item" <?php echo e($order->isFinanciallyLocked() ? 'disabled' : ''); ?>>
                                        </div>
                                        ...
                                        <div class="md:col-span-2" :class="item.product_id ? 'md:col-start-5' : ''">
                                            ...
                                            <input type="number" :name="`items[${index}][quantity]`"
                                                ...
                                                class="w-full text-sm border-gray-300 rounded-md disabled:bg-gray-100"
                                                required <?php echo e($order->isFinanciallyLocked() ? 'disabled' : ''); ?>>
                                        </div>
                                        ...
                                        <div class="md:col-span-1">
                                            ...
                                            <input type="number" step="0.001" :name="`items[${index}][weight_kg]`"
                                                ...
                                                class="w-full text-sm border-gray-300 rounded-md disabled:bg-gray-100" <?php echo e($order->isFinanciallyLocked() ? 'disabled' : ''); ?>>
                                        </div>
                            ...
                            <div>
                                ...
                                <select name="shipping_provider_id" x-model="shipping_provider_id"
                                    ...
                                    <?php $__currentLoopData = $shippingProviders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($p->id); ?>" <?php echo e(old('shipping_provider_id', $order->shipping_provider_id) == $p->id ? 'selected' : ''); ?>><?php echo e($p->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div>
                    ...
                    <?php if($order->isFinanciallyLocked()): ?>
                        <div class="bg-amber-50 border-l-4 border-amber-600 rounded-r-xl shadow-sm p-4">
                            ...
                            <p class="text-xs text-amber-800 leading-tight">Prices and items cannot be edited because the order
                                has been marked as PAID (<?php echo e($order->financial_locked_at->format('M d, Y')); ?>).</p>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-6">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="border-t border-gray-100 pt-3 mt-3 shadow-inner bg-gray-50 -mx-6 px-6 pb-2">
                                ...
                                <div class="flex gap-2">
                                    <select name="order_discount_type" x-model="order_discount_type"
                                        ...
                                        class="w-1/2 text-sm border-gray-300 rounded-md disabled:bg-gray-200" <?php echo e($order->isFinanciallyLocked() ? 'disabled' : ''); ?>>
                                        <option value="none">None</option>
                                        <option value="percent">Percent (%)</option>
                                        <option value="fixed">Fixed ($)</option>
                                    </select>
                                    <input type="number" step="0.01" name="order_discount_value"
                                        ...
                                        class="w-1/2 text-sm border-gray-300 rounded-md disabled:bg-gray-200" <?php echo e($order->isFinanciallyLocked() ? 'readonly' : ''); ?>>
                                </div>
                            ...
                            <div class="border-t border-gray-100 pt-3 mt-3">
                                ...
                                <div class="flex gap-2">
                                    <input type="number" step="0.01" name="shipping_cost" x-model.number="shipping_cost"
                                        @input="calculateTotals()"
                                        class="w-2/3 text-sm border-gray-300 rounded-md disabled:bg-gray-200" <?php echo e($order->isFinanciallyLocked() ? 'readonly' : ''); ?>>
                            ...
                            <div class="pt-3">
                                ...
                                <input type="number" name="delivery_period_days" value="<?php echo e($order->delivery_period_days); ?>"
                        ...
                        <div class="mt-6">
                            <button type="submit"
                                ...
                                :disabled="items.length === 0 && !<?php echo e($order->isFinanciallyLocked() ? 'true' : 'false'); ?>">
                                Save Changes
                            </button>
                        </div>
                    </div>
    ...
    <script>
        function orderEditForm() {
            return {
                items: <?php echo buildAlpineArray($order->items); ?>,
                nextId: 999, // safe buffer

                // Initial setup
                order_discount_type: '<?php echo e($order->order_discount_type); ?>',
                order_discount_value: <?php echo e(floatval($order->order_discount_value)); ?>,
                shipping_cost: <?php echo e(floatval($order->shipping_cost)); ?>,
                shipping_provider_id: '<?php echo e(old('shipping_provider_id', $order->shipping_provider_id)); ?>',
                client_id: '<?php echo e(old('client_id', $order->client_id)); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\handmade handicraft\Desktop\Dev\ecom\resources\views/admin/orders/edit.blade.php ENDPATH**/ ?>