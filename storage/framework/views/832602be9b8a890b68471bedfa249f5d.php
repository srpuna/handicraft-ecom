                ...
                <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-3">
                    <?php if($siteSettings['navbar_logo'] && $siteSettings['navbar_logo']->value): ?>
                        <img src="<?php echo e(asset('storage/' . $siteSettings['navbar_logo']->value)); ?>"
                            alt="<?php echo e($siteSettings['site_name']); ?>" class="h-12 w-auto object-contain">
                    <?php else: ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <?php if($siteSettings['footer_logo'] && $siteSettings['footer_logo']->value): ?>
                        <img src="<?php echo e(asset('storage/' . $siteSettings['footer_logo']->value)); ?>"
                            alt="<?php echo e($siteSettings['site_name']); ?>" class="h-16 w-auto object-contain mb-4">
                    <?php else: ?>
                    ...
                    <ul class="space-y-3 text-gray-300 text-sm">
                        ...
                        <?php if($siteSettings['footer_phone']): ?>
                            <li class="flex items-center gap-2">
                                ...
                                <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $siteSettings['footer_phone'])); ?>"
                                    class="hover:text-gold"><?php echo e($siteSettings['footer_phone']); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if($siteSettings['footer_email']): ?>
                            <li class="flex items-center gap-2">
                                ...
                                <a href="mailto:<?php echo e($siteSettings['footer_email']); ?>"
                                    class="hover:text-gold"><?php echo e($siteSettings['footer_email']); ?></a>
                            </li>
                        <?php endif; ?>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-300 text-sm">
                        ...
                        <li><a href="<?php echo e(route('home', ['filter' => 'new-arrivals'])); ?>" class="hover:text-gold">New
                                Arrivals</a></li>
                        <li><a href="<?php echo e(route('home', ['filter' => 'featured'])); ?>" class="hover:text-gold">Featured
                                Products</a></li>
                        <li><a href="<?php echo e(route('home', ['filter' => 'on-sale'])); ?>" class="hover:text-gold">On Sale</a>
                        </li>
                        <li><a href="<?php echo e(route('pages.shipping-policy')); ?>" class="hover:text-gold">Shipping Policy</a>
                        </li>
                    </ul>
                </div>
