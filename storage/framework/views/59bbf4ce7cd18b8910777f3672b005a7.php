    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <dd class="mt-1 text-lg font-semibold <?php echo e($role->name === 'super_admin' ? 'text-purple-700' : 'text-gray-900'); ?>">
                    ...
                    <div class="grid grid-cols-2 gap-4 pt-4 border-t">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                <?php echo e($role->created_at->format('M d, Y - H:i')); ?>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                <?php echo e($role->updated_at->format('M d, Y - H:i')); ?>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">
                    Permissions
                    <span class="text-sm font-normal text-gray-500 ml-2">(<?php echo e($role->permissions->count()); ?>)</span>
                </h2>
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="space-y-4">
                    <div class="bg-blue-50 rounded-lg p-4 border border-blue-100">
                        ...
                        <div class="text-3xl font-bold text-blue-900 mt-1"><?php echo e($role->users->count()); ?></div>
                    </div>

                    <div class="bg-green-50 rounded-lg p-4 border border-green-100">
                        <div class="text-sm text-green-600 font-medium">Total permissions</div>
                        <div class="text-3xl font-bold text-green-900 mt-1"><?php echo e($role->permissions->count()); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <h2 class="text-xl font-semibold text-gray-800 mb-4">
                    Users
                    <span class="text-sm font-normal text-gray-500 ml-2">(<?php echo e($role->users->count()); ?>)</span>
                </h2>
                ...
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.users.show', $user)); ?>" 
                        ...
                        <div class="flex-shrink-0 h-10 w-10 bg-green-100 rounded-full flex items-center justify-center">
                            <span class="text-green-600 font-semibold"><?php echo e(strtoupper(substr($user->name, 0, 1))); ?></span>
                        </div>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\My Files\Dev\ecom\resources\views/admin/roles/show.blade.php ENDPATH**/ ?>